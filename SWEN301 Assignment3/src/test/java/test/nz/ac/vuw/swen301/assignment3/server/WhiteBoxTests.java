...
public class WhiteBoxTests {
    ...
    public void testDo1PostNEW(){
        ...
        String j = "[\"{\\\"id\\\":\\\"96898390-4676-459f-b437-ac10cb4a9320\\\",\\\"message\\\":\\\"TEST\\\",\\\"timestamp\\\":\\\"2019-06-12T12:06:10.431Z\\\",\\\"thread\\\":\\\"createDummyLogs\\\",\\\"logger\\\":\\\"serverTest\\\",\\\"level\\\":\\\"FATAL\\\",\\\"errorDetails\\\":\\\"java.lang.RuntimeException\\\"}\"]";
    ...
    public void testDOMultiplePostNEW(){
        ...
        LogServer service = new LogServer();
        ...
        request2.setParameter("level","TEST0");

        service.doGet(request2, response2);
        JSONArray newatt = null;
        try {
            newatt = new JSONArray(response2.getContentAsString());
